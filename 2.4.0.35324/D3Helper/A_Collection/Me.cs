...
namespace D3Helper.A_Collection
{
    class Me
    {
        ...
        {
            //--
            public static string ParagonPoints_FilePath = AppDomain.CurrentDomain.BaseDirectory + @"paragonpoints.txt";
        ...
        {
            //--
            public static string GearSwaps_FilePath = AppDomain.CurrentDomain.BaseDirectory + @"gearswaps.txt";
        ...
        {
            //--
            public static string FilePath = AppDomain.CurrentDomain.BaseDirectory + @"overrides.txt";
        ...
        {
            public static string SkillBuilds_FilePath = AppDomain.CurrentDomain.BaseDirectory + @"skillbuilds.txt";
